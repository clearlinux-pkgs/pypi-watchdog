...
%prep
%setup -q -n watchdog-2.1.9
cd %{_builddir}/watchdog-2.1.9
pushd ..
cp -a watchdog-2.1.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656362390
...
cp %{_builddir}/watchdog-2.1.9/COPYING %{buildroot}/usr/share/package-licenses/pypi-watchdog/aa949e9aeb3398f2f58b1f03baba6c0b2173a476
cp %{_builddir}/watchdog-2.1.9/LICENSE %{buildroot}/usr/share/package-licenses/pypi-watchdog/2b8b815229aa8a61e483fb4ba0588b8b6c491890
