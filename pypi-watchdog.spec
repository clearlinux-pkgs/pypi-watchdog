...
Source0  : https://files.pythonhosted.org/packages/90/61/ddbf959d24fab35a98a8311e95d581e55109560e524f1a5a299ee991499d/watchdog-2.1.8.tar.gz
...
%prep
%setup -q -n watchdog-2.1.8
cd %{_builddir}/watchdog-2.1.8
pushd ..
cp -a watchdog-2.1.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653006301
...
cp %{_builddir}/watchdog-2.1.8/COPYING %{buildroot}/usr/share/package-licenses/pypi-watchdog/aa949e9aeb3398f2f58b1f03baba6c0b2173a476
cp %{_builddir}/watchdog-2.1.8/LICENSE %{buildroot}/usr/share/package-licenses/pypi-watchdog/2b8b815229aa8a61e483fb4ba0588b8b6c491890
