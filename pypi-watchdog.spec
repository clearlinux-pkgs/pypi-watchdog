...
Source0  : https://files.pythonhosted.org/packages/cd/3c/43eeaa9ea17a2657d639aa3827beaa77042809410f86fb76f0d0ea6a2102/watchdog-4.0.0.tar.gz
...
%prep
%setup -q -n watchdog-4.0.0
cd %{_builddir}/watchdog-4.0.0
pushd ..
cp -a watchdog-4.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707320925
