...
Source0  : https://files.pythonhosted.org/packages/a5/17/a31fc6b90ff861a27debd0650bfbca17e074fdc3e037f392872fad76c726/watchdog-2.3.1.tar.gz
...
%prep
%setup -q -n watchdog-2.3.1
cd %{_builddir}/watchdog-2.3.1
pushd ..
cp -a watchdog-2.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677601973
