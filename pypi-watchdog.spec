...
Source0  : https://files.pythonhosted.org/packages/b3/d2/a04951838e0b0cea20aff5214109144e6869101818e7f90bf3b68ea2facf/watchdog-2.1.7.tar.gz
...
%prep
%setup -q -n watchdog-2.1.7
cd %{_builddir}/watchdog-2.1.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649794255
...
cp %{_builddir}/watchdog-2.1.7/COPYING %{buildroot}/usr/share/package-licenses/pypi-watchdog/aa949e9aeb3398f2f58b1f03baba6c0b2173a476
cp %{_builddir}/watchdog-2.1.7/LICENSE %{buildroot}/usr/share/package-licenses/pypi-watchdog/2b8b815229aa8a61e483fb4ba0588b8b6c491890
