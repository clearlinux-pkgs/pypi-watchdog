...
Source0  : https://files.pythonhosted.org/packages/c3/fb/bd960970258366b0704307ccd12617d64201407bfb6d31ae412d2762ccf1/watchdog-2.2.0.tar.gz
...
%prep
%setup -q -n watchdog-2.2.0
cd %{_builddir}/watchdog-2.2.0
pushd ..
cp -a watchdog-2.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670499938
